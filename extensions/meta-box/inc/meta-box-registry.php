...
class RWMB_Meta_Box_Registry {
	...
	public function make( $settings ) {
		$class_name = apply_filters( 'rwmb_meta_box_class_name', 'WV_Meta_Box', $settings );
	 ...
	 *
	 * @param WV_Meta_Box $meta_box Meta box instance.
	 */
	public function add( WV_Meta_Box $meta_box ) {
	 ...
	 *
	 * @return WV_Meta_Box|bool False or meta box object.
	 */
