...
if ( ! class_exists( 'WV_MB_Tabs' ) ) {
	class WV_MB_Tabs {
		 ...
		 *
		 * @param WV_Meta_Box $obj Meta Box object.
		 */
		public function opening_div( WV_Meta_Box $obj ) {
		 ...
		 * @param WV_Meta_Box $obj Meta Box object.
		 */
		public function show_nav( WV_Meta_Box $obj ) {
			if ( ! $this->active ) {
				return;
			}
		 ...
		 * @param WV_Meta_Box $obj Meta Box object.
		 */
		public function show_panels( WV_Meta_Box $obj ) {
			if ( ! $this->active ) {
				return;
			}
