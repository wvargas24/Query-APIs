 ...
 * @subpackage Meta Box Group
 */
class WV_RWMB_Group_Field extends RWMB_Field {
	/**
	...
	public static function html( $meta, $field ) {
		...
		foreach ( $field['fields'] as $child_field ) {
			...
			self::call( 'show', $child_field, WV_RWMB_Group::$saved );
		}
	...
	public static function normalize( $field ) {
		...
		$field['fields'] = empty( $field['fields'] ) ? [] : WV_Meta_Box::normalize_fields( $field['fields'] );
