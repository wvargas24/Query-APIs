 ...
 * @return array
 */
function blokhausre_listing_layout_metabox_tab( $metabox_tabs ) {
	if ( is_array( $metabox_tabs ) ) {

		$metabox_tabs['listing_layout'] = array(
			'label' => blokhausre_option('cls_layout', 'Layout'),
...
add_filter( 'blokhausre_property_metabox_tabs', 'blokhausre_listing_layout_metabox_tab', 90 );
 ...
 * @return array
 */
function blokhausre_listing_layout_metabox_fields( $metabox_fields ) {
	$blokhausre_prefix = 'mls_';

	$fields = array(
		array(
            'id' => "{$blokhausre_prefix}single_top_area",
        ...
        array(
            'id' => "{$blokhausre_prefix}single_content_area",
...
add_filter( 'blokhausre_property_metabox_fields', 'blokhausre_listing_layout_metabox_fields', 90 );
